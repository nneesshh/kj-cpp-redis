...
extern INLINE void			bip_buf_destroy(bip_buf_t *bb);
...
extern INLINE int			bip_buf_get_committed_sum(bip_buf_t *bb, int reset);
extern INLINE size_t		bip_buf_get_reservation_size(const bip_buf_t *bb);
extern INLINE char *		bip_buf_get_contiguous_block(const bip_buf_t *bb);

extern INLINE char *		bip_buf_find_str(const bip_buf_t *bb, const char *str, size_t str_len);
...
extern size_t				bip_buf_decommit(bip_buf_t *bb, size_t size);
